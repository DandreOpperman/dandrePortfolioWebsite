export const projects = [
  ...
  },
  {
    ...
    subtitle: "frontend",
    description:
      "This cross platform app and website alows users to set financial goals, track spending that occurs monthly and daily, see that spending visualised graphically and make financial descions accordingly. Importantly this group project was coded in Flutter in the DART coding language. our team decided that the two week project phase would be an opertunity to showcase our ability to learn new technologies fast, use documentation to overcome obsticles and execute asthetically pleasing and technically robust fullstack coding projects. For a demo and explination of the application please watch this video https://youtu.be/zg74qv8YIL0",
    image: "./project-4.gif",
